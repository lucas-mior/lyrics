...
#define ENUM_FIELDS \
    X(LRC_LYRICS_PREPROCESS_SPLIT_SIZE_CURRENT)  \
    X(LRC_LYRICS_PREPROCESS_SPLIT_SIZE_WORD)     \
    X(LRC_LYRICS_PREPROCESS_SPLIT_SIZE_CHAR)     \
    X(LRC_LYRICS_PREPROCESS_SPLIT_SIZE_SENTENCE)
...
#define ENUM_FIELDS \
    X(LRC_LYRICS_PREPROCESS_STAR_FREQUENCY_NONE)    \
    X(LRC_LYRICS_PREPROCESS_STAR_FREQUENCY_EDGES)   \
    X(LRC_LYRICS_PREPROCESS_STAR_FREQUENCY_SEGMENT)
#define XENUMS_NO_TESTS 1
#include "cbase/xenums.c"
#undef XENUMS_NO_TESTS
...
#define ENUM_FIELDS \
    X(LRC_LYRICS_PREPROCESS_ROMANIZATION_OFF) \
    X(LRC_LYRICS_PREPROCESS_ROMANIZATION_ICU)
#define XENUMS_NO_TESTS 1
#include "cbase/xenums.c"
#undef XENUMS_NO_TESTS
